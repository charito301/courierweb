...
<body>
    ...
    <table class="frame" style="margin-left: auto; margin-right: auto; width: 30em;"
        border="0" cellpadding="0" cellspacing="0">
        <tr>
            <td>
                <div class="sectionTitle" style="text-align: center;">
                    <asp:Label runat="server" ID="lblPageTitle" Text="Operator Login"></asp:Label>
                </div>
            </td>
        </tr>
        <tr>
                    ...
                    <div class="sideBorders">
                        <div class="stepContent">
                                ...
                                <table border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td class="formInputRow">
                                            <asp:Label ID="lblSalesLocation" runat="server" CssClass="formInputCaption" Text="Operator:"></asp:Label><br />
                                    ...
                                    <tr>
                                        <td class="formInputRow">
                                            <asp:Label ID="lblPassword" runat="server" CssClass="formInputCaption" Text="Password:"></asp:Label><br />
                            ...
                            <asp:Panel runat="server" ID="pnlButtonsRow">
                                <div class="formInputButtonsRow" style="text-align: center;">
                                    &nbsp;
